...
namespace MaterialManagement.Services
{
    public class BaseService<T> : IService<T> where T : class
    {
        ...
        public readonly MaterialManagementContext _context;
        public BaseService(MaterialManagementContext context, IMemoryCache cache, IConfiguration configuration)
        {
            _context = context;
            _cache = cache;
